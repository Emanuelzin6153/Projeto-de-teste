...
3. O marcador aparecerá automaticamente no mapa

### Encontrar Coordenadas

Use o Google Maps ou OpenStreetMap:

1. Abra [openstreetmap.org](https://www.openstreetmap.org)
2. Procure o endereço do escritório
3. Clique direito no local e copie as coordenadas (latitude, longitude)
...
**Dúvidas?** Consulte a documentação do Leaflet: [leafletjs.com](https://leafletjs.com)
